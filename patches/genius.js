...
// Genius Bar by tank#0001, made into a Bot Patch by xfuney
...
module.exports.config = function() {
    ...
    console.log("Genius by tank#0001 requires no configuration.\n")
}

// This is called when the root bot is successfully logged into Discord.
...
module.exports.run = async function(client, Discord) {
    console.log("Genuis Bar by tank#0001 on bot " + client.user.tag);
